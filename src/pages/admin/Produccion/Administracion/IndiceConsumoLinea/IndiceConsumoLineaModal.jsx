...
import { DatosMetaLinea } from '@schema/Produccion/Administracion/IndiceConsumoLinea.schema';
...
export default function IndiceConsumoLineaModal({ open, onClose, onSave }) {
  ...
  const handleValidation = async () => {
    const result = DatosMetaLinea.safeParse(form);
    if (!result.success) {
