...
export default function ModalDesempeñoMes({ open, onClose, fetchById, id }) {
      ...
      try {
        ...
        if (resp?.ok) {
          ...
          setChart({
            ...
            consumo_energia_electrica: g.consumo_energia_electrica ?? [],
          });
        } else {
  ...
  const series = useMemo(
    () => [
      ...
      {
        name: 'Consumo energia electrica',
        data: chart.consumo_energia_electrica,
      },
    ],
    [chart.produccion, chart.consumo_energia_electrica],
  );
