...
export default function ModalDesempeñoMes({ open, onClose, fetchById, id }) {
      ...
      try {
        ...
        if (resp?.ok) {
          ...
          setChart({
            ...
            cisterna_agua: g.cisterna_agua ?? [],
            medidor_subestacion_ee: g.medidor_subestacion_ee ?? [],
            medidor_tres_produccion: g.medidor_tres_produccion ?? [],
            medidor_cuatro_eliza: g.medidor_cuatro_eliza ?? [],
            medidor_cinco_administracion: g.medidor_cinco_administracion ?? [],
            medidor_seis_arcilla: g.medidor_seis_arcilla ?? [],
          });
        } else {
  ...
  const series = useMemo(
    () => [
      ...
      { name: 'Cisterna agua', data: chart.cisterna_agua },
      { name: 'Medidor subestacion ee', data: chart.medidor_subestacion_ee },
      { name: 'Medidor tres produccion', data: chart.medidor_tres_produccion },
      { name: 'Medidor cuatro eliza', data: chart.medidor_cuatro_eliza },
      {
        name: 'Medidor cinco administracion',
        data: chart.medidor_cinco_administracion,
      },
      {
        name: 'Medidor seis arcilla',
        data: chart.medidor_seis_arcilla,
      },
    ],
    [
      chart.produccion,
      chart.cisterna_agua,
      chart.medidor_subestacion_ee,
      chart.medidor_tres_produccion,
      chart.medidor_cuatro_eliza,
      chart.medidor_cinco_administracion,
      chart.medidor_seis_arcilla,
    ],
  );
