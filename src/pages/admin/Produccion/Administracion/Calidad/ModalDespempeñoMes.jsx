...
export default function ModalDesempeñoMes({ open, onClose, fetchById, id }) {
  ...
  const series = useMemo(
    () => [
      { name: '%1ra calidad', data: chart.primera },
      { name: '%2ra calidad', data: chart.segunda },
      { name: '%3ra calidad', data: chart.tercera },
      { name: '%Cascote', data: chart.cascote },
    ],
    [chart.primera, chart.segunda, chart.tercera, chart.cascote],
  );
          ...
          <>
            ...
            <div className="p-4 sm:p-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                <div className="lg:col-span-6 rounded-2xl border border-slate-200 bg-white shadow-sm">
