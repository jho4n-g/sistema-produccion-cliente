...
import { DatosMetaProduccion } from '@schema/Produccion/Administracion/Produccion.schema';
...
export default function ProduccionModal({ open, onClose, onSave }) {
  ...
  const handleValidation = async () => {
    const result = DatosMetaProduccion.safeParse(form);
    if (!result.success) {
