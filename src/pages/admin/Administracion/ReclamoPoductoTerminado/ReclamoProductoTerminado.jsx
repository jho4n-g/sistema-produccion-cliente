...
import {
  ...
  getIdObj,
  registerObj,
} from '@service/Administracion/ReclamoProductoTerminado.services';
import ConfirmModal from '@components/ConfirmModal';
import ReclamoProductoTerminadoModal from './ReclamoProductoTerminadoModal';
...
const columnas = [
  ...
  },
  {
    ...
    render: (row) => normalizarFecha(row.fecha_produccion),
  },
  {
    label: 'Cantidad',
    key: 'cantidad',
  },
  {
    ...
    key: 'devolucion_producto',
  },
  {
    label: 'Devolucion economica',
    key: 'devolucion_economica',
  },
  {
    label: 'Procedente',
    key: 'procedente',
...
export default function ReclamoProductoTerminado() {
