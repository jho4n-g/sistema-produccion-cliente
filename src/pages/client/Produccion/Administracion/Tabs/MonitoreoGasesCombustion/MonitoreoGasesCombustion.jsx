...
export default function IndiceConsumoLinea() {
  ...
  const series = [{ name: 'Horno B', data: datosGrafico?.horno_b }];
  const seriesB = [{ name: 'Horno C', data: datosGrafico?.horno_c }];
  const seriesC = [{ name: 'Horno D', data: datosGrafico?.horno_d }];
