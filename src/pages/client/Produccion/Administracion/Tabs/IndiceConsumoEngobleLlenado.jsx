...
//
import { DatosIndiceConsumoEngobe } from '@schema/Produccion/Administracion/IndiceConsumoEngobe.schema';
//
import { registerObj } from '@service/Produccion/Administracion/IndiceConsumoEngobe.services';
...
export default function IndiceConsumoBasesLlenado() {
  ...
  const handleValidation = async () => {
    const result = DatosIndiceConsumoEngobe.safeParse(form);
    if (!result.success) {
