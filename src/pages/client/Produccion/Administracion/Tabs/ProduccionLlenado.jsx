...
//
import { DatosProduccion } from '@schema/Produccion/Administracion/Produccion.schema';
//
import { registerObj } from '@service/Produccion/Administracion/Produccion.services';
...
export default function IndiceConsumoLineaLlenado() {
  ...
  const handleValidation = async () => {
    const result = DatosProduccion.safeParse(form);
    if (!result.success) {
