...
//
import { DatosIndiceConsumoLinea } from '@schema/Produccion/Administracion/IndiceConsumoLinea.schema';
//
import { registerObj } from '@service/Produccion/Administracion/IndiceConsumoLinea.services';
...
export default function IndiceConsumoLineaLlenado() {
  ...
  const handleValidation = async () => {
    const result = DatosIndiceConsumoLinea.safeParse(form);
    if (!result.success) {
