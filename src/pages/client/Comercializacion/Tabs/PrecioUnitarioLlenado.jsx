...
//
import { registerObj } from '@service/Comercializacion/PrecioUnitario.services';
...
export default function CalidadLlenado() {
  ...
  const handleValidation = async () => {
    const result = DatosPrecioUnitario.safeParse(form);
    if (!result.success) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          <div className="md:col-span-1 lg:col-span-6">
            <InputField
              ...
              type="number"
              name="region_centro"
              value={form?.region_centro || ''}
              onChange={updateBase}
              error={error.region_centro}
            />
          </div>
          <div className="md:col-span-1 lg:col-span-6">
            <InputField
              ...
              type="number"
              name="region_este"
              value={form?.region_este || ''}
              onChange={updateBase}
              error={error.region_este}
            />
          </div>
          <div className="md:col-span-1 lg:col-span-6">
            <InputField
              ...
              type="number"
              name="region_oeste"
              value={form?.region_oeste || ''}
              onChange={updateBase}
              error={error.region_oeste}
            />
          </div>
          <div className="md:col-span-1 lg:col-span-6">
            <InputField
